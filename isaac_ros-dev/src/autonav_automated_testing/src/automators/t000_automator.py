...
class T000Automator(BaseAutomator):
    ...
    def print_status(self):
        box = (
            ...
            '#         T000 DAQ MODE              #\n'
            '######################################\n'
            f'#  Odom : {self._tag(self.odom_online):<8}  GPS : {self._tag(self.gps_online):<8} #\n'
            f'#  Joy  : {self._tag(self.joy_online):<8}  IMU : {self._tag(self.imu_online):<8} #\n'
            f'#  DAQ  : {self._daq_state():<28} #\n'
