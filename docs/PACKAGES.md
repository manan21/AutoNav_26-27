...
**Retired Gazebo Classic assets.** This package has `COLCON_IGNORE`; use the standalone `autonav_sim` repo for the active ROS Humble + Gazebo Fortress IGVC simulation.
...
**Retired Gazebo Classic package.** This package has `COLCON_IGNORE`; use the standalone `autonav_sim` repo for the active ROS Humble + Gazebo Fortress IGVC simulation.
