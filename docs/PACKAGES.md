...
**Retired Gazebo Classic assets.** This package has `COLCON_IGNORE`; use the standalone [`autonav_sim`](https://github.com/blobspire/autonav_sim) repo for the active ROS Humble + Gazebo Fortress simulation package `igvc_competition_sim`.
...
**Retired Gazebo Classic package.** This package has `COLCON_IGNORE`; use the standalone [`autonav_sim`](https://github.com/blobspire/autonav_sim) repo for the active ROS Humble + Gazebo Fortress simulation package `igvc_competition_sim`.
